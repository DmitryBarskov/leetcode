// @leetup=custom
// @leetup=info id=1464 lang=java slug=maximum-product-of-two-elements-in-an-array
...
* Input: nums = [3,4,5,2]
* Output: 12 
* Explanation: If you choose the indices i=1 and j=2 (indexed from 0), you wil
* l get the maximum value, that is, (nums[1]-1)*(nums[2]-1) = (4-1)*(5-1) = 3*4 = 
* 12. 
* 
* Example 2:
* 
