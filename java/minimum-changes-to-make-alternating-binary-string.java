// @leetup=custom
// @leetup=info id=1758 lang=java slug=minimum-changes-to-make-alternating-binary-string
...
* Input: s = "0100"
* Output: 1
* Explanation: If you change the last character to '1', s will be "0101", whic
* h is alternating.
*
* Example 2:
*
...
class Solution {
    public int minOperations(String s) {
        ...
        return Math.min(changesTo01, changesTo10);
    }
}
// @leetup=code
