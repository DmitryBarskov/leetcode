// @leetup=custom
// @leetup=info id=2706 lang=java slug=buy-two-chocolates
...
* Output: 0
* Explanation: Purchase the chocolates priced at 1 and 2 units respectively. Y
* ou will have 3 - 3 = 0 units of money afterwards. Thus, we return 0.
*
* Example 2:
*
