; @leetup=custom
; @leetup=info id=380 lang=ruby slug=insert-delete-getrandom-o1
...
(define obj (new randomized-set%))
(println (send obj insert 0))
(println (send obj insert 1))
(println (send obj remove 0))
(println (send obj get-random))
(println (send obj insert 2))
(println (send obj remove 1))
(println (send obj get-random))
