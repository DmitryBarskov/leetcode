...
def heap_pop(array)
  ...
  while from < array.size
    ...
    child = i
    if j < array.size && yield(array[i], array[j]) < 0
      child = j
    end
...
k_closest([[32,-20],[34,-34],[34,-31],[-53,52],[-98,-70],[-15,73],[-41,-94],[95,-78],[-42,-7],[-11,-37],[-94,26],[-74,-53],[68,72],[2,-80],[-58,-94],[48,-80],[-57,-35]], 10).sort => [[-74, -53], [-57, -35], [-53, 52], [-42, -7], [-15, 73], [-11, -37], [2, -80], [32, -20], [34, -34], [34, -31]]
